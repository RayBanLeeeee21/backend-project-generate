...
if __name__ == '__main__':
    ...
    utils.write_json('tables/test_table-1.json', ddl_data_1, indent=2)

    sql_str_2 = ddl_to_sql(ddl_data_1)
    utils.write_str( 'tables/test_table-2.sql', sql_str_2)

    ddl_data_2 = sql_to_ddl(sql_str_2)
    utils.write_json('tables/test_table-2.json', ddl_data_2, indent=2)
